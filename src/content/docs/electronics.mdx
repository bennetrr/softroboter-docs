...
<TextWithRightImage image={{src: 'electronics/hub.jpg', alt: 'HUB nach dem Druck'}}>
...
<TextWithRightImage image={{src: 'electronics/electronics_testing.jpg', alt: 'Testen der Steuerelektronik'}}>
